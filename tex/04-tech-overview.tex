...
Novi komunikacijski kanal se stvara s \mintinline{haskell}{newChan} funkcijom:
...
Novi podatak se u kanal stavlja pomoću \mintinline{haskell}{writeChan}
funkcijom:
...
Spajanje na server se vrši pomoću \mintinline{py3}{connect()} funkcije kojoj se
...
i \mintinline{c}{recv} ili kao i u Haskellu se socket može pretvoriti u handle
